...
"""
Azure sample code
https://github.com/Azure-Samples/customvision-export-samples/tree/main/samples/python
"""
...
tags = config["AzureCV"]["tags"].split(",")
tag_ids = {}
for tag in tags:
    tag_ids[tag] = trainer.create_tag(project.id, tag).id
